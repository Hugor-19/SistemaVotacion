...
public class Candidato implements Serializable {
    ...
    // Constructor con imagen en byte[]
    public Candidato(String nombre, String apellido, String cedula, String partidoPolitico, byte[] imagen, String propuesta, String estado) {
        this.nombre = nombre;
